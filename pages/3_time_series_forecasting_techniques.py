...
st.markdown("In both examples, Prophet is used to create a forecast by fitting a model to historical data and making predictions for future dates. The resulting forecasts can be used to make informed decisions about resource allocation, inventory management, and other business operations.")
st.subheader('E. LSTM')
st.markdown("""
